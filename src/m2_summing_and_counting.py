...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = .10203  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(5,10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = -2.05978  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_from():
    ...
    # Test 3:
    expected = 8
    answer = count_sines_from(10,20)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 2
    answer = count_sines_from(13,16)
    ...
    # Test 6:
    expected = 4
    answer = count_sines_from(125,130)
