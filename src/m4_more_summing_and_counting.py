...
def run_test_factorial():
    ...
    # Test 5:
    answer_from_oracle = math.factorial(1357)
    answer_from_my_code = factorial(1357)
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 2
    answer = count_cosines_from(10,13,0)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 2
    answer = count_cosines_from(100,105,.5)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 0
    answer = count_cosines_from(0,100,2)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 1
    answer = count_cosines_from(0,6,.788)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 4
    answer = count_cosines_from(11,15,-1)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 4:
    expected = .07733  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(100,107)
